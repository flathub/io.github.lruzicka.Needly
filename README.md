...
- `io.github.lruzicka.Needly.png` - Application Icon
...
5. **Python dependencies**:
   - Python Flit core
   - Python setuptools - install from pip
   - Python wheel - install from pip
...
- `--filesystem=xdg-documents` - To access Documents and its subdirectiories
- `--filesystem=xdg-run/libvirt` - To be able to read from Libvirt VM
